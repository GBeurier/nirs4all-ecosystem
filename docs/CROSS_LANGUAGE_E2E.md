...
| `e2e-core-ui-custom-app-host` | A custom client host records the R binding surface, runs nirs4all-core WASM predictions against a Python oracle, and renders reusable nirs4all-ui result components. |
