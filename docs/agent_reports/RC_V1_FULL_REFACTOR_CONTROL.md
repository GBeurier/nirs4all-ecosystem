...
- `nirs4all-cockpit` RC head now includes `71786b1 docs(snapshot): refresh planned rc surface heads`; planned RC surfaces now point to `nirs4all-ui` `8f9f2f6`, `nirs4all-providers` `5146908`, and `nirs4all-tools` `7c5070f` in `data/current.json`.
...
- Latest pushed/tagged heads after the security/parity/CI refresh batch: Python `3d568ab`, Studio `1d1ded5`, Web `1ccb839`, UI `8f9f2f6`, Providers `5146908`, Tools `7c5070f`, Cockpit `71786b1`, Benchmarks `45f4cf7`, Cluster `c4df557`; Ecosystem uses the current board HEAD for this note.
